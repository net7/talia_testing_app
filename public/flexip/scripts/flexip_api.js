...
function FJSAPI (varName, flashID, containerID, flWidth, flHeight, flVersion, commModURL, imageModURL, sideMenuModURL, flSkin, flexipSwfPath) {
  this.name = varName;
  ...
  this.flexipRef = null;
  this.logText = null;  
  this.flexipSwfPath = flexipSwfPath || '';

  this.openLogWindow = function () {
    this.logWin = window.open("scripts/jslog.html", "logWindow", 'width=500,height=400,x=10,y=10,scrollbars=yes,toolbar=no,status=no,resizable=no,location=no'); 
  ...
  this.initialize = function() {
    ...
    swfobject.embedSWF(this.flexipSwfPath+"Flexip_app.swf?anticache="+now.getTime(), 
              this.containerID, 
              this.flWidth,
              this.flHeight,
              this.flVersion,
